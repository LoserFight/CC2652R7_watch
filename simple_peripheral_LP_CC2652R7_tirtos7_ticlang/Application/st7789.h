...
/* Pin connection*/
#define ST7789_RST_PORT CONFIG_GPIO_RES_tft
#define ST7789_RST_PIN  CONFIG_GPIO_RES_tft
#define ST7789_DC_PORT  CONFIG_GPIO_CSDC
#define ST7789_DC_PIN   CONFIG_GPIO_CSDC
...
/* Basic operations */
#define ST7789_RST_Clr() GPIO_write(CONFIG_GPIO_RES_tft, 0);
#define ST7789_RST_Set() GPIO_write(CONFIG_GPIO_RES_tft, 1);

#define ST7789_DC_Clr() GPIO_write(CONFIG_GPIO_CSDC, 0);
#define ST7789_DC_Set() GPIO_write(CONFIG_GPIO_CSDC, 1);
